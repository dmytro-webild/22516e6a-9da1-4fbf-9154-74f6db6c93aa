...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      carouselItems={[
        ...
        {
          id: "2",
          imageSrc: "http://img.b2bpic.net/free-photo/blurred-traffic-light-trails-road-night_1359-421.jpg",
          imageAlt: "Sports car on highway",
        },
        {
          id: "3",
          imageSrc: "http://img.b2bpic.net/free-photo/full-shot-couple-near-car_23-2148744015.jpg",
